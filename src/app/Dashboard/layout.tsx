...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ backgroundColor: "rgb(239, 231, 231)" }}>
      <Row>
            ...
            <Flex vertical gap={30}>
              ...
              <Flex vertical gap={15}>
                {navbarData1.map((file, index) => {
                  return (
                    <Link href={file.link ? file.link : ""} key={index}>
                      <Flex
                        key={index}
                      ...
                      >
                          ...
                          style={{
                            ...
                            backgroundColor:
                              selected === file.name
                                ? "#7F1126"
                                : "transparent",
                            fill: selected === file.name ? "white" : "black",
                            borderRadius: 8,
                            padding: 5,
                          }}
                        >
                        ...
                        <Typography.Text style={{ padding: 5 }}>
                          {file.name}
                        </Typography.Text>
                      </Flex>
                    </Link>
                          ...
                          style={{
                            ...
                            backgroundColor:
                              selected === file.name
                                ? "#7F1126"
                                : "transparent",
                            color: selected === file.name ? "white" : "black",
                            borderRadius: 8,
                            padding: 5,
                          }}
                        >
                    ...
                    >
                      <div
                        style={{
                          cursor: "pointer",
                          backgroundColor:
                            selected === file.name ? "#7F1126" : "transparent",
                          color: selected === file.name ? "white" : "black",
                          borderRadius: 8,
                          padding: 5,
                        }}
        ...
        >
          ...
          <Row>
            <Col
              lg={24}
              style={{ width: "100%", height: "110vh", padding: 20 }}
            >
              {children}
            </Col>
          </Row>
